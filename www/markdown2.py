...
def markdown(text, html4tags=True, tab_width=DEFAULT_TAB_WIDTH, safe_mode=None,
             extras=["fenced-code-blocks", "tables", "footnotes", "code-color"], 
             link_patterns=None, footnote_title=None, 
             footnote_return_symbol=None, use_file_vars=False):
    return Markdown(html4tags=html4tags, tab_width=tab_width,
                    safe_mode=safe_mode, extras=extras,
                    link_patterns=link_patterns,
                    footnote_title=footnote_title,
